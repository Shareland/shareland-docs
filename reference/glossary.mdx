...
<ResponseField name="Collateral">
  SQFT tokens used to secure a borrow position. Shareland requires a minimum collateralization ratio (MCR) of 110%. If your ratio drops to 110%, your position is automatically liquidated. Recommended minimum is 120%.
</ResponseField>
