...
<AccordionGroup>
  ...
  <Accordion title="How is SQFT priced?">
    Each SQFT token tracks the price per square foot of residential real estate in a specific geography. Prices are set by Shareland's oracle, which aggregates recent home sales, listing data, and historical trends to produce a live $/sqft price for each market. The methodology was developed with Dr. Susan Wachter and Dr. Andrey Pavlov at the Wharton School.
  </Accordion>
